...
import { Modal, Form, Input, Button, Select, DatePicker, InputNumber, Upload } from "antd";
    ...
    return (
        ...
        >
            ...
            <Form form={form} layout="vertical" onFinish={onFinish}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }} className="form-section">
                    {/* Cột trái */}
                    <div>
                        <Form.Item
                            label="Mã tài sản"
                    ...
                    <div>
                        ...
                        >
                            <InputNumber
                                ...
                                parser={(val) => val?.replace(/,/g, "") as string}
                            />
                        </Form.Item>
